...
*
* Description: MPI golden regression test for fermionic MC gradient + SR natural gradient.
...
struct FermionMCSRGoldenMPITest : MPITest {
...
TEST_F(FermionMCSRGoldenMPITest, MCEnergyGradientAndSRGoldenMPI) {
  if (mpi_size != 2) {
  ...
  if (kPrintGolden) {
    PrintCurrentValues("fermion_mc+sr_mpi",
                       eval_res.energy,
                       grad_norm,
                       grad_probe,
                       grad_probe_rand1,
  ...
  if constexpr (std::is_same_v<TenElemT, QLTEN_Double>) {
    constexpr double kEnergyReal = 1.9890371589207452;
    constexpr double kEnergyImag = 0.0;
    constexpr double kGradNorm = 55.476275499330598;
    constexpr double kGradProbeReal = 15.605833622573844;
    constexpr double kGradProbeImag = 0.0;
    constexpr double kGradProbeRand1Real = -0.064846955365698733;
    constexpr double kGradProbeRand1Imag = 0.0;
    constexpr double kGradProbeRand2Real = 1.2790195849270303;
    constexpr double kGradProbeRand2Imag = 0.0;
    constexpr double kNatGradNorm = 3.3458951259299798;
    constexpr double kNatGradProbeReal = 1.1727416668143362;
    constexpr double kNatGradProbeImag = 0.0;
    constexpr double kNatGradProbeRand1Real = 0.55217151511300111;
    constexpr double kNatGradProbeRand1Imag = 0.0;
    constexpr double kNatGradProbeRand2Real = 0.36812576131628227;
    constexpr double kNatGradProbeRand2Imag = 0.0;
    constexpr size_t kCGIters = 4;
    ...
    constexpr double kEnergyReal = 0.21809887241301879;
    constexpr double kEnergyImag = -0.56854692544776109;
    constexpr double kGradNorm = 15.073183775383381;
    constexpr double kGradProbeReal = 4.2084089304548975;
    constexpr double kGradProbeImag = 0.10082494523729943;
    constexpr double kGradProbeRand1Real = 3.0837140405342391;
    constexpr double kGradProbeRand1Imag = 2.0332334074555636;
    constexpr double kGradProbeRand2Real = 1.5165679430349719;
    constexpr double kGradProbeRand2Imag = 1.1986547855422884;
    constexpr double kNatGradNorm = 1.3729689958992126;
    constexpr double kNatGradProbeReal = 0.41088971165132759;
    constexpr double kNatGradProbeImag = 0.0096609924707127832;
    constexpr double kNatGradProbeRand1Real = 0.41027054299264942;
    constexpr double kNatGradProbeRand1Imag = -0.23075610664260893;
    constexpr double kNatGradProbeRand2Real = 0.57096256894070008;
    constexpr double kNatGradProbeRand2Imag = -0.035360842412067911;
