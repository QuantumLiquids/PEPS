...
*
* Description: Golden regression test for bosonic MC gradient + SR natural gradient.
*   Mirrors test_fermion_mc_sr_golden.cpp for the bosonic (TrivialRepQN) path.
*/
...
struct BosonMCSRGoldenTest : MPITest {
...
TEST_F(BosonMCSRGoldenTest, MCEnergyGradientAndSRGolden) {
  ...
  if (kPrintGolden) {
    PrintCurrentValues("boson_mc+sr",
                       eval_res.energy,
                       grad_norm,
                       grad_probe,
                       grad_probe_rand1,
  ...
  if constexpr (std::is_same_v<TenElemT, QLTEN_Double>) {
    constexpr double kEnergyReal = 0.28133159289109844;
    constexpr double kEnergyImag = 0.0;
    constexpr double kGradNorm = 0.79448749386266548;
    constexpr double kGradProbeReal = 0.19497292702538344;
    constexpr double kGradProbeImag = 0.0;
    constexpr double kGradProbeRand1Real = 0.5325174841273419;
    constexpr double kGradProbeRand1Imag = 0.0;
    constexpr double kGradProbeRand2Real = 0.59428831724772024;
    constexpr double kGradProbeRand2Imag = 0.0;
    constexpr double kNatGradNorm = 0.17183039289721974;
    constexpr double kNatGradProbeReal = 0.042247449362668166;
    constexpr double kNatGradProbeImag = 0.0;
    constexpr double kNatGradProbeRand1Real = -0.084481382411202816;
    constexpr double kNatGradProbeRand1Imag = 0.0;
    constexpr double kNatGradProbeRand2Real = -0.16415479961525778;
    ...
    constexpr double kEnergyReal = 0.7212115176595868;
    constexpr double kEnergyImag = -0.0080622982033243529;
    constexpr double kGradNorm = 1.3690111008564421;
    constexpr double kGradProbeReal = 0.56628908016951762;
    constexpr double kGradProbeImag = 0.012988454983467297;
    constexpr double kGradProbeRand1Real = 1.5438403947912447;
    constexpr double kGradProbeRand1Imag = 0.39392797778640531;
    constexpr double kGradProbeRand2Real = 1.4301957615015739;
    constexpr double kGradProbeRand2Imag = 0.80527620162809221;
    constexpr double kNatGradNorm = 1.3495126608339902;
    constexpr double kNatGradProbeReal = 0.48857862323448575;
    constexpr double kNatGradProbeImag = 0.01142739017458449;
    constexpr double kNatGradProbeRand1Real = 0.83765744213302873;
    constexpr double kNatGradProbeRand1Imag = -0.12760712529833673;
    constexpr double kNatGradProbeRand2Real = 2.2631652329455525;
    constexpr double kNatGradProbeRand2Imag = 0.67273614581797125;
