...
using SquareTPSSample3SiteExchangeT = SquareTPSSample3SiteExchange<QLTEN_Complex, U1QN>;
...
TEST_F(SpinSystemVMCPEPS, SquareHeisenbergD4StochasticGradient) {
  optimize_para.wavefunction_path = "zvmc_tps_heisenbergD" + std::to_string(params.D);

  using Model = SpinOneHalfHeisenbergSquare<QLTEN_Complex, U1QN>;
  VMCPEPSExecutor<QLTEN_Complex, U1QN, SquareTPSSampleFullSpaceNNFlipT, Model> *executor(nullptr);
...
TEST_F(SpinSystemVMCPEPS, SquareHeisenbergD4BMPSSingleSiteVariational) {
  ...
  optimize_para.wavefunction_path = "zvmc_tps_heisenbergD" + std::to_string(params.D);
  using Model = SpinOneHalfHeisenbergSquare<QLTEN_Complex, U1QN>;
  VMCPEPSExecutor<QLTEN_Complex, U1QN, TPSSampleNNFlipT, Model> *executor(nullptr);
...
TEST_F(SpinSystemVMCPEPS, SquareJ1J2D4) {
  using Model = SpinOneHalfJ1J2HeisenbergSquare<QLTEN_Complex, U1QN>;
  optimize_para.wavefunction_path = "zvmc_tps_heisenbergD" + std::to_string(params.D);
  VMCPEPSExecutor<QLTEN_Complex, U1QN, TPSSampleNNFlipT, Model> *executor(nullptr);
  double j2 = 0.2;
  Model j1j2solver(j2);
...
TEST_F(SpinSystemVMCPEPS, TriHeisenbergD4) {
  ...
  VMCPEPSExecutor<QLTEN_Complex, U1QN, SquareTPSSample3SiteExchangeT, Model> *executor(nullptr);
