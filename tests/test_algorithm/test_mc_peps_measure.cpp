...
TEST_F(Test2x2MCPEPSBoson, TransverseIsingModel) {
  ...
  // Load TPS data from file (generated by test_exact_sum_optimization.cpp)
  std::string tps_path = (std::filesystem::path(TEST_SOURCE_DIR) /
...
TEST_F(Test2x2MCPEPSFermion, SpinlessFermionModel) {
  ...
  MCMeasurementPara para = MCMeasurementPara(
    ...
    compatible_config,
    // Load TPS data from path (generated by test_exact_sum_optimization.cpp)
    (std::filesystem::path(TEST_SOURCE_DIR) / GetTPSDataPath("spinless_fermion_tps_t2_0.000000")).string());
...
TEST_F(Test2x2MCPEPSFermion, TJModel) {
  ...
  MCMeasurementPara para = MCMeasurementPara(
    ...
    compatible_config,
    // Load TPS data from path (generated by test_exact_sum_optimization.cpp)
    (std::filesystem::path(TEST_SOURCE_DIR) / GetTPSDataPath("tj_model_tps")).string());
