...
#ifndef QLPEPS_ALGORITHM_VMC_UPDATE_WAVE_FUNCTION_COMPONENT_CLASSES_SQUARE_TPS_SAMPLE_TJSUBSPACE_3SITE_EXCHANGE_H
#define QLPEPS_ALGORITHM_VMC_UPDATE_WAVE_FUNCTION_COMPONENT_CLASSES_SQUARE_TPS_SAMPLE_TJSUBSPACE_3SITE_EXCHANGE_H
...
class SquareTPSSampletJ3SiteExchange : public WaveFunctionComponent<TenElemT, QNT> {
  using WaveFunctionComponentT = WaveFunctionComponent<TenElemT, QNT>;
 public:
  TensorNetwork2D<TenElemT, QNT> tn;

  SquareTPSSampletJ3SiteExchange(const size_t rows, const size_t cols) : WaveFunctionComponentT(rows, cols),
                                                                         tn(rows, cols) {}

  SquareTPSSampletJ3SiteExchange(const SplitIndexTPS<TenElemT, QNT> &sitps, const Configuration &config)
 ...
 private:
  ///< for hilbert space constructed by |empty>, |up>, |down>
...
#endif //QLPEPS_ALGORITHM_VMC_UPDATE_WAVE_FUNCTION_COMPONENT_CLASSES_SQUARE_TPS_SAMPLE_TJSUBSPACE_3SITE_EXCHANGE_H
