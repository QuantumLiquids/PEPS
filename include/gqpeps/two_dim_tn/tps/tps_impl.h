...
*
* Description: GraceQ/VMC-PEPS project. The generic tensor product state (TPS) class, implementation.
*/

#ifndef GQPEPS_VMC_PEPS_TWO_DIM_TN_TPS_TPS_IMPL_H
#define GQPEPS_VMC_PEPS_TWO_DIM_TN_TPS_TPS_IMPL_H
...
#endif //GQPEPS_VMC_PEPS_TWO_DIM_TN_TPS_TPS_IMPL_H
