...
*
* Description: GraceQ/VMC-PEPS project. A fix size matrix tensor matrix class
*/


#ifndef GQPEPS_TWO_DIM_TN_FRAMEWORK_TEN_MATRIX_H
#define GQPEPS_TWO_DIM_TN_FRAMEWORK_TEN_MATRIX_H

#include "gqpeps/two_dim_tn/framework/duomatrix.h"    //DuoMatrix
...
#endif //GQPEPS_TWO_DIM_TN_FRAMEWORK_TEN_MATRIX_H
