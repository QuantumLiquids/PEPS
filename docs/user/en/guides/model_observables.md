...
| `SquareSpinOneHalfJ1J2XXZModel` | `energy`, `spin_z`, `bond_energy_h`, `bond_energy_v`, `bond_energy_dr`, `bond_energy_ur` | Site fields `{Ly,Lx}`; bond energies `{bond_id}` | Matches legacy outputs for NN/NNN bond energies. |
