...
- OBC：`#include "qlpeps/algorithm/vmc_update/model_solvers/transverse_field_ising_square_obc.h"`
- PBC：`#include "qlpeps/algorithm/vmc_update/model_solvers/transverse_field_ising_square_pbc.h"`

**类名**：

- OBC：`TransverseFieldIsingSquareOBC`
- PBC：`TransverseFieldIsingSquarePBC`

**构造函数**：
- OBC：`TransverseFieldIsingSquareOBC(double h)`
- PBC：`TransverseFieldIsingSquarePBC(double h)`
...
详细的开发指南请参阅：**[自定义能量求解器](../howto/write_custom_energy_solver.md)**
